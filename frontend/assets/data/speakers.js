module.exports = [
    ...
    },
    {
        ...
        "summary": "Webでリアルタイム通信を実現するWebSocket。<br>WebSocketと言えば、Socket.IO(node)やActionCable(Rails5)なんかはメジャーですが、さて、PHPではどうしましょうか。まだデファクトが無いですよね。<br>いろいろ調べて試してわかったことを、お伝えしたいと思います。",
    ...
    },
    {
        ...
        time: "14:00-14:30",
        name:"山岡広幸",
        "title": "合同会社テンマドの代表社員・エンジニア。自社プロダクトを開発しつつ、複数の会社で社外CTOやアドバイザーを務めています",
    ...
    },
    {
        ...
        "github": "",
        "other": "http://decr.jp/",
        "other": "http://kaz29.hatenablog.com/",
    },
    {
        track:"907",
        time: "16:15-16:45",
